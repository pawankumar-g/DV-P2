  ...
  const subjects = [
    {
      ...
      icon: Calculator,
      color: "blue",
      description: "Master numerical reasoning, problem-solving, and mathematical concepts",
      resources: 1250,
    ...
    },
    {
      ...
      icon: Brain,
      color: "purple",
      description: "Develop logical thinking and language pattern recognition",
      resources: 750,
    ...
    },
    {
      ...
      icon: Shapes,
      color: "orange",
      description: "Enhance spatial awareness and visual problem-solving abilities",
      resources: 650,
      difficulty: "All Levels",
    },
  ]
                    ...
                    <Card className="border-blue-200 shadow-xl">
                      <CardHeader>
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900">Sample {subject.name} Question</h4>
                            <p className="text-sm text-gray-600">Try this example problem</p>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent>
                          ...
                          <div className="p-4 bg-gray-50 rounded-lg">
                            <p className="text-sm text-gray-700 mb-3">
                              {subject.id === "mathematics"
                                ...
                                : subject.id === "english"
                                  ? "Choose the word that best completes the sentence: 'The ancient castle stood _____ on the hilltop.'"
                                  : subject.id === "verbal-reasoning"
                                    ? "Complete the analogy: Cat is to Kitten as Dog is to _____"
                                    : "Which shape comes next in this sequence? ○ □ ○ □ ○ ?"}
                            </p>
                            {subject.id === "mathematics" ? (
                              <div className="space-y-2">
                                <div className="p-2 bg-blue-100 rounded border border-blue-200 text-sm">60 mph ✓</div>
                                <div className="p-2 bg-white rounded border text-sm">50 mph</div>
                                <div className="p-2 bg-white rounded border text-sm">70 mph</div>
                              </div>
                            ) : subject.id === "english" ? (
                              <div className="space-y-2">
                                <div className="p-2 bg-white rounded border text-sm">proudly</div>
                                <div className="p-2 bg-blue-100 rounded border border-blue-200 text-sm">
                                  majestically ✓
                                </div>
                                <div className="p-2 bg-white rounded border text-sm">quickly</div>
                              </div>
                            ) : subject.id === "verbal-reasoning" ? (
                              <div className="space-y-2">
                                <div className="p-2 bg-white rounded border text-sm">Pet</div>
                                <div className="p-2 bg-blue-100 rounded border border-blue-200 text-sm">Puppy ✓</div>
                                <div className="p-2 bg-white rounded border text-sm">Animal</div>
                              </div>
                            ) : (
                              <div className="space-y-2">
                                <div className="p-2 bg-white rounded border text-sm">○</div>
                                <div className="p-2 bg-blue-100 rounded border border-blue-200 text-sm">□ ✓</div>
                                <div className="p-2 bg-white rounded border text-sm">△</div>
                              </div>
                            )}
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Difficulty: {subject.difficulty}</span>
                            <span className="text-blue-600 font-medium">View Explanation</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
