...
//                 Resources
//               </Link>
//               <a href="/practice" className="text-blue-600 font-medium">
//                 Practice Tests
//               </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-blue-100 text-blue-700 hover:bg-blue-200">
              {practiceTests.length} Practice Tests Available
            </Badge>
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              11+ <span className="text-blue-600">Practice Tests</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap gap-4 justify-center mb-8">
            ...
            {subjects.map((subject) => (
              ...
              >
                {subject.icon === "calculator" && <Calculator className="h-4 w-4 mr-2" />}
                {subject.icon === "pen" && <PenTool className="h-4 w-4 mr-2" />}
                {subject.icon === "brain" && <Brain className="h-4 w-4 mr-2" />}
                {subject.icon === "shapes" && <Shapes className="h-4 w-4 mr-2" />}
                {subject.name}
              </Button>
            ))}
            <Button
